...
import { BookOpen, GraduationCap, Binary, AlertCircle } from 'lucide-react';
...
export const Education: React.FC = () => {
  ...
  const educationData = [
    ...
    },
    {
      ...
      institution: "Université Clermont Auvergne",
      period: "Licence 1",
      description: "Première année de parcours en mathématiques et informatique.",
      icon: GraduationCap,
      mood: "positive",
  ...
  const selectedEducation = educationData.find(item => item.period === selectedPeriod);
